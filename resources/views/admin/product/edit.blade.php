        ...
        <div class="row">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="url" name="url" placeholder="" value="{{ $product->url }}">
                            </div>
                            <div class="form-group">
                                <label>Tóm tắt</label>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Hình ảnh chi tiết sản phẩm</h3>
                        </div>
                ...
                <div class="row">
                    <div class="box-body">
                        ...
                        <h4> Thay đổi số lượng sản phẩm</h4>
                        @foreach($stock as $s)
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="exampleInputFile">size {{ $s->size }}</label>
                                    <input type="number" class="form-control" id="size" name="size{{ $s->size }}" value="{{ $s->stock }}">
                                </div>
                            </div>
                        @endforeach
                    </div>
