...
@section('content')
    ...
    <section class="product-page">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 sl-js">
                    <div class="swiper-container ">
                        <div class="swiper-wrapper">

                            <div class="swiper-slide"><img src="{{ asset($product->image) }}" class="img-responsive" ></div>
                            @foreach($imageProduct as $i_product)
                                <div class="swiper-slide"><img src="{{ asset($i_product->image) }}" class="img-responsive" ></div>
                            @endforeach
